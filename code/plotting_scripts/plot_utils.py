...
def plot_transaction_distribution(total_money_transacted_per_timestep, bins=20, alpha=0.7, color='blue'):
    """
    ...
    # save plot in plots folder with date and time
    os.makedirs("plots", exist_ok=True)
    title = "tx_amount_distribution"
...
def plot_transaction_counts(transaction_counts, bins=20, alpha=0.7, color='green'):
    """
